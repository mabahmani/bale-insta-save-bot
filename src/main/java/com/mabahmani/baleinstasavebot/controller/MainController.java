...
import com.mabahmani.baleinstasavebot.model.Media;
import com.mabahmani.baleinstasavebot.model.MediaType;
    ...
    private Long sendMessage(String text, Long chatId, Long replyId) {
        try {
            ...
            Response response = OkHttpClient.getInstance().newCall(
                    new Request.Builder()
                            .post(body)
                            .url(String.format("https://tapi.bale.ai/bot%s/sendMessage", BaleInstaSaveBotApplication.botToken)).build()
            ).execute();
    ...
    private Long editMessage(String text, Long chatId, Long messageId) {
        try {
            ...
            Response response = OkHttpClient.getInstance().newCall(
                    new Request.Builder()
                            .post(body)
                            .url(String.format("https://tapi.bale.ai/bot%s/EditMessageText", BaleInstaSaveBotApplication.botToken)).build()
            ).execute();
